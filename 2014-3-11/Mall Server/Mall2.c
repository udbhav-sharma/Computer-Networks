...
main()
{
    ...
    strcpy( unix_serv_addr.sun_path,"/tmp/temp_Mall2");
    ...
    printf("Created Socket for Mall1\n");
    fflush(stdout);
    ...
    strcpy(unix_serv_addr2.sun_path,"/tmp/temp_Mall3");
