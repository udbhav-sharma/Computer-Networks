...
#define my_portno 11000
#define max_connection_limit 1
...
main()
{
    ...
    strcpy(unix_serv_addr.sun_path,"/tmp/temp_Mall1");
    ...
    strcpy(unix_serv_addr2.sun_path,"/tmp/temp_Mall2");
